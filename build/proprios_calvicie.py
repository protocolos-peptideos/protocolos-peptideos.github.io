...
"proprio_calvicie": dict(
    ...
    nota_refs=(f"Todas as contagens desta página foram levantadas por mim em {_DT}, com a consulta declarada ao lado de cada número. As indicações citadas vêm da classe terapêutica declarada no dado aberto da ANVISA e do campo de condição dos registros de fase 3 — não de bula lida por mim, e a página não afirma mais do que isso. <strong>Esta página foi apurada em dia próprio</strong>, e por isso carrega data própria."),
    referencias=[
