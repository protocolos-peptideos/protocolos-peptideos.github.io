...
"proprio_musculo_hpg": dict(
    ...
    nota_refs=(f"Todas as contagens desta página foram levantadas por mim em {_DT}, com a consulta declarada ao lado de cada número. As ressalvas de largura de busca — gonadorelina, enclomifeno e imunofan — estão escritas antes das tabelas. <strong>Esta página foi apurada em dia próprio</strong>, e por isso carrega data própria."),
    referencias=[
