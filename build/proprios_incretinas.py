...
"proprio_incretinas": dict(
    ...
    nota_refs=(f"Todas as contagens desta página foram levantadas por mim em {_DT}, nas bases citadas, com a consulta declarada ao lado de cada número. Os registros individuais que abri estão linkados abaixo. <strong>Esta página foi apurada em dia próprio</strong>, e por isso carrega data própria."),
    referencias=[
